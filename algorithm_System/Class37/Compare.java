...
public class Compare {
    ...
    public static void functionTest() {
        ...
        for (int i = 0; i < testTime; i++) {
            ...
            if (treeMap.containsKey(querryK) != avl.containsKey(querryK) || sbt.containsKey(querryK) != skip.containsKey(querryK) || treeMap.containsKey(querryK) != sbt.containsKey(querryK)) {
    ...
    public static void performanceTest() {
        ...
        System.out.println("treeMap运行时间:" + (end - start) + "ms");
        ...
        System.out.println("AVL运行时间:" + (end - start) + "ms");
        ...
        System.out.println("sbt运行时间:" + (end - start) + "ms");
        ...
        System.out.println("skip运行时间:" + (end - start) + "ms");
