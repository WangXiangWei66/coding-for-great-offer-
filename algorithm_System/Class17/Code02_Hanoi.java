...
public class Code02_Hanoi {
    ...
    public static void leftToRight(int n) {
        ...
        leftToMid(n - 1);
        System.out.print("Move" + n + "from left to right");
        midToRight(n - 1);
    }
    ...
    public static void leftToMid(int n) {
        ...
        leftToRight(n - 1);
        System.out.print("Move" + n + "from left to mid");
        rightToMid(n - 1);
    }
    ...
    public static void midToRight(int n) {
        ...
        midToLeft(n - 1);
        System.out.print("Move" + n + "from mid to right");
        leftToRight(n - 1);
    }
    ...
    public static void midToLeft(int n) {
        ...
        midToRight(n - 1);
        System.out.print("Move" + n + "from mid to left");
        rightToLeft(n - 1);
    }
    ...
    public static void rightToLeft(int n) {
        ...
        rightToMid(n - 1);
        System.out.print("Move" + n + "from right to left");
        midToLeft(n - 1);
    }
