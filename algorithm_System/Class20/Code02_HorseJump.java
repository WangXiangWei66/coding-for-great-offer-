...
public class Code02_HorseJump {
    ...
    public static int f(int i, int j, int step, int a, int b) {
        ...
        return f(i + 2, j + 1, step - 1, a, b) + f(i + 1, j + 2, step - 1, a, b) + f(i - 1, j + 2, step - 1, a, b) + f(i - 2, j + 1, step - 1, a, b) + f(i - 2, j - 1, step - 1, a, b) + f(i - 1, j - 2, step - 1, a, b) + f(i + 1, j - 2, step - 1, a, b) + f(i + 2, j - 1, step - 1, a, b);
    }
