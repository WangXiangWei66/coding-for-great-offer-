package Class07;
//一定要注意看main函数及其注释，用代码展示加强堆的用法
//展示了加强堆如何支持基础类型和非基础类型


public class Code02_ShowHeapGreater {
    //一定自己定义非基础类型
    ...
    public static void main(String[]args){
        ...
        //生成一个加强堆
        //排序策略是年龄小的放在堆顶，年龄小根堆
        Code03_HeapGreater.HeapGreater<Student> heap1=new Code03_HeapGreater.HeapGreater<>((a, b)->a.age-b.age);
        //把所有学生加入堆
        heap1.push(s1);
        heap1.push(s2);
        heap1.push(s3);
        ...
        //arr[4]==3
        //每个位置一定会自带一个下标，这是一定的
        //任何基础类型的元素，天生一定会带一些类似下标的身份信息的！这是一定的
        //生成一个加强堆
        //加强堆里只放下标即可，因为通过下标可以找到数字
        //排序策略是：
        //数字小的下标，在堆顶
        Code03_HeapGreater.HeapGreater<Integer>heap2=new Code03_HeapGreater.HeapGreater<>((i,j)->arr[i]-arr[j]);
